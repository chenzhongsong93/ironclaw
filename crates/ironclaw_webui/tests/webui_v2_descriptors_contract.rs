// arch-exempt: large_file, caller coverage shares the existing route fixture until WebUI v2 tests are split, plan #3031
...
fn expected_table() -> Vec<Expected> {
    vec![
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_GET_THREAD_PLAN,
            method: NetworkMethod::Get,
            pattern: "/api/webchat/v2/threads/{thread_id}/plan",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_GET_RUN_STATE,
            method: NetworkMethod::Get,
            pattern: "/api/webchat/v2/threads/{thread_id}/runs/{run_id}",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
