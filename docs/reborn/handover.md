...
- 主机 80、8181、API `/api/health`、Gateway 3000 与 5188 均 HTTP 200；Chromium 检查 80/8181 两页 root 挂载、page error 0。API/Gateway/Web 已从本地最新代码重建；Web image `sha256:b3bc896015d7e636c66dd32c3e042b474a4af0f701c2f2d8c9a3021957857148` 标记 revision `20f20a014a9e93d74c2c972793c176c0dc0860b0`。本轮没有重启或重置 PostgreSQL/Rena。此前隔离 Todo、真实子 Agent 状态/消息/返回与父子权限、整页 UI 控件、零额度、正文直接 PUT/force 422 及活跃续期证据仍见天权交接 2026-09-25 项。
