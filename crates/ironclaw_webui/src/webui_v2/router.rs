...
use crate::webui_v2::descriptors::{
    ...
    WEBUI_V2_PATTERN_GET_RUN_STATE, WEBUI_V2_PATTERN_GET_SESSION, WEBUI_V2_PATTERN_GET_THREAD_PLAN,
    ...
    WEBUI_V2_PATTERN_LIST_PROJECTS, WEBUI_V2_PATTERN_LIST_SKILLS, WEBUI_V2_PATTERN_LLM_SUBJECT_KEY,
    WEBUI_V2_PATTERN_LOGS, WEBUI_V2_PATTERN_OPERATOR_CONFIG, WEBUI_V2_PATTERN_OPERATOR_CONFIG_KEY,
...
pub fn webui_v2_router_with_options(state: WebUiV2State, options: WebUiV2RouteOptions) -> Router {
    let mut router = Router::new()
        ...
        .route(
            ...
            get(handlers::get_thread_plan),
        )
        .route(WEBUI_V2_PATTERN_GET_RUN_STATE, get(handlers::get_run_state))
        ...
        .route(
            ...
            get(handlers::list_commands).post(handlers::execute_command),
        )
        .route(
    ...
    if options.mount_llm_config_routes {
        router = router
            ...
            .route(
                WEBUI_V2_PATTERN_LLM_SUBJECT_KEY,
                get(handlers::get_llm_subject_key_status)
                    .put(handlers::put_llm_subject_key)
                    .delete(handlers::delete_llm_subject_key),
            )
            .route(
