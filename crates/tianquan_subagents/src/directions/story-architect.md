...
| **imagery_tone（意象/语气派,2026-08-25 用户反馈"句子式不得劲"后补）** | 矛盾意象组合/专属名词/狂气语气——不走"老实交代设定"的句子式,走气质记忆点 | 8-9（上限更高,顶级爆款多在此档:道诡异仙/我不是戏神/十日终焉） | 道诡异仙（道×诡异矛盾意象,四字,邪性）；我不是戏神（狂气否定式）；十日终焉（意象+时间压迫） |

**计分规则（番茄档）**：金手指信号词（觉醒/绑定/获得/系统）+8；矛盾组合
（死×生/病×神/弱×强）+5；飞卢风（逗号分隔完整句）+5；**否定词（不/无/别/莫）
-10**（例外:狂气否定式如"我不是X"可豁免,语气本身即卖点）；超字数硬 veto。

**高维技巧（拉开与公式化命名的差距）**：
- **意象派构造法（句子式的天花板补充）**：句子式保证及格线,但"按公式做出来的名字"
  读起来得劲不起来。意象派三路:①矛盾意象嫁接(两个不该同框的意象硬接,如"道×诡异"、
  "终焉×十日");②专属名词化(把书里核心概念造成一个只属于本书的词,读者看到词就
  想知道意思);③狂气语气(名字本身就是一句狂话/宣判,自带情绪张力)。**自检:把候选
  名和"道诡异仙/十日终焉"摆一起,气质掉不掉档?掉=重来。**
- **职业猎奇维度（教学式,勿直接照抄示例成品）**：公式=〔冷门禁忌职业〕×〔能力
  动词〕,职业自带猎奇流量;自问"这个职业的日常动作里,哪个能一句话讲清金手指?"
  （示例结构:殡葬类职业×视觉能力→"为死者服务的人看见了活人看不见的东西"——
  掌握结构后用本书职业重新推导,禁止照搬示例词句）。
- **公式叠加记忆点**：「XX怪谈」「别XX」类公式已被用烂，必须叠职业/反差/
  梗感才及格。
- **3 秒法则**：读者扫到书名 3 秒内必须懂卖点（猎奇点或金手指直给）——但"懂"
  可以是懂情绪(狂/邪/冷)而非只懂设定。
- **双轨出候选**：句子式(及格保障)与意象派(上限冲击)各出至少 2 个,标注流派让用户选口味。
